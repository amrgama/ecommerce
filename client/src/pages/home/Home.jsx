    ...
    <div className="home">
              ...
              <div className="carousel-inner rounded-3">
                <div className="carousel-item active">
                  ...
                  <div className="carousel-caption text-start">
                    <span className="text-danger fs-7 text-uppercase">Best Sake</span>
                    <h1 className="fs-2 text-black fw-bolder">
                      <Link to={"/"} className="nav-link">iPad S13+ Pro.</Link>
                    </h1>
                    <p>From $999.00 <br /> or $41.62/mo.</p>
                    <button className="buy-btn rounded-pill px-3 py-2 bg-light">
                      <Link to={"/"} className="nav-link text-capitalize fs-7 fw-bold text-primary">buy now</Link>
                    </button>
                  </div>
                </div>
          ...
          <div className="col-12 col-lg-6 p-3 pt-0 pt-lg-3 pe-lg-0 d-flex flex-wrap justify-content-center align-items-center">
              <div className="col-12 col-sm-6 p-2 d-flex justify-content-end align-items-center align-items-sm-start small-banner position-relative">
                ...
                <div className="small-banner-content position-absolute p-5 p-sm-4 text-start">
                  <span className="text-danger fs-9 text-uppercase d-block mb-2">Best Sake</span>
                  <h2 className="fs-5 fs-sm-6 fw-bold text-capitalize mb-2">
                    <Link to={"/"} className="nav-link">iPad S13+ Pr</Link>
                  </h2>
                  <p className="fs-sm-8">
              ...
              <div className="col-12 col-sm-6 p-2 d-flex justify-content-end align-items-center align-items-sm-start small-banner position-relative">
                ...
                <div className="small-banner-content p-5 p-sm-4 text-start position-absolute">
                  <span className="text-danger fs-9 text-uppercase d-block mb-2">NEW ARRIVAL</span>
                  <h2 className="fs-5 fs-sm-6 fw-bold text-capitalize mb-2">
                    <Link to={"/"} className="nav-link">But IPad Air</Link>
                  </h2>
                  <p className="fs-sm-8">
                    From $999.00 <br /> or $41.62/mo.
                  </p>
      ...
      <Section className="home-wrapper-2">
        <div className="servies row gap-3 align-items-center justify-content-center justify-content-lg-between">
          <div className="w-fit-content d-flex align-items-center gap-3">
            ...
            <div>
              <h3 className="text-capitalize fs-7 fw-bolder mb-1">free shipping</h3>
          ...
          <div className="w-fit-content d-flex align-items-center gap-3">
            ...
            <div>
              <h3 className="text-capitalize fs-7 fw-bolder mb-1">daily surprises offers</h3>
          ...
          <div className="w-fit-content d-flex align-items-center gap-3">
            ...
            <div>
              <h3 className="text-capitalize fs-7 fw-bolder mb-1">support 24/7</h3>
          ...
          <div className="w-fit-content d-flex align-items-center gap-3">
            ...
            <div>
              <h3 className="text-capitalize fs-7 fw-bolder mb-1">affordable prices</h3>
          ...
          <div className="w-fit-content d-flex align-items-center gap-3">
            ...
            <div>
              <h3 className="text-capitalize fs-7 fw-bolder mb-1">secure payment</h3>
        ...
        <div className="row">
          ...
          <div className="h-100 famous-card card justify-content-between bg-dark position-relative border-0 shadow-sm overflow-hidden">
              <div className="famous-content px-3 py-4">
                ...
                <p className="text-white-50 fs-8">From $399or $16.62/mo. for 24 mo.*</p>
              </div>
              <img
                src="images/tab1.jpg"
                className="img-fluid"
      ...
      <Section className="brands home-wrapper-7">
        <div className="row align-item-center justify-content-center justify-content-lg-between p-3 gap-3 bg-white rounded-3 shadow-sm">
          <img src="images/brand-01.png" alt="" className="shadow-sm d-inline-block" />
          <img src="images/brand-02.png" alt="" className="shadow-sm d-inline-block" />
          <img src="images/brand-03.png" alt="" className="shadow-sm d-inline-block" />
          <img src="images/brand-04.png" alt="" className="shadow-sm d-inline-block" />
          <img src="images/brand-05.png" alt="" className="shadow-sm d-inline-block" />
          <img src="images/brand-06.png" alt="" className="shadow-sm d-inline-block" />
          <img src="images/brand-07.png" alt="" className="shadow-sm d-inline-block" />
        </div>
      </Section>
    </div>
  );
